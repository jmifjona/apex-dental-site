// Blog post data — managed by scripts/publish-next-blog.mjs
// Do not edit manually; use the queue system

export const blogPosts = [
  {
    id: 1,
    slug: '/blog/dental-implants-cost-malta/',
  ...
  {
    id: 2,
    slug: '/blog/veneers-vs-teeth-whitening/',
  ...
  {
    id: 3,
    slug: '/blog/dental-emergency-malta/',
  ...
  {
    id: 4,
    slug: '/blog/clear-aligners-adults-malta/',
  ...
  {
    id: 5,
    slug: '/blog/dental-hygiene-appointments/',
  ...
  {
    id: 6,
    slug: '/blog/dental-crowns-protect-teeth/',
...
export const blogPostMeta = Object.fromEntries(
  blogPosts.map(p => [p.id, {
    slug: p.slug,
    title: p.title,
    description: p.excerpt,
    image: `https://apexdentalmalta.com${p.image}`,
