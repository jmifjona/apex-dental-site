    ...
    return (
      <section className="mx-auto max-w-7xl px-6 py-18 lg:px-8">
        <div className="mb-10 grid gap-8 lg:grid-cols-[1fr_1fr]">
          <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-white/5 p-3 shadow-xl shadow-black/20 backdrop-blur-sm">
            <img src={branding.CT2} alt="Dental emergency care" className="h-[360px] w-full rounded-[1.5rem] object-cover" />
          </div>
          <div className="rounded-[2rem] border border-white/10 bg-white/5 p-7 shadow-xl shadow-black/20 backdrop-blur-sm">
            <p className="text-sm font-semibold uppercase tracking-[0.25em] text-cyan-300">Need urgent help?</p>
            <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">Same-day emergency dental care when possible.</h2>
            <p className="mt-5 leading-8 text-slate-300">
              If you have severe pain, swelling, trauma, a broken tooth, or a lost restoration, contact Apex Dental as soon as possible. The priority is to reduce pain, control infection, and stabilise the tooth or area safely.
            </p>
            <a href="https://wa.me/35679854037" className="mt-8 inline-flex items-center gap-2 rounded-full bg-cyan-300 px-6 py-3 font-semibold text-slate-950 shadow-lg shadow-cyan-500/20 transition hover:scale-[1.02]">
              WhatsApp Emergency
              <ChevronRight className="h-4 w-4" />
            </a>
          </div>
        ...
        <div className="mb-12 grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="rounded-[2rem] border border-white/10 bg-white/5 p-7 backdrop-blur-sm">
            <p className="text-sm font-semibold uppercase tracking-[0.25em] text-cyan-300">Common emergencies</p>
            <div className="mt-6 space-y-4">
          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/5 p-7 backdrop-blur-sm">
            <p className="text-sm font-semibold uppercase tracking-[0.25em] text-cyan-300">What to do first</p>
            <div className="mt-6 space-y-5 text-slate-300">
              {actionSteps.map((item, idx) => (
                <div key={item} className="flex gap-4">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-cyan-300/15 text-sm font-semibold text-cyan-200">{idx + 1}</div>
        ...
        <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.25em] text-cyan-300">How we help</p>
            <h3 className="mt-3 text-3xl font-semibold tracking-tight">Fast assessment, pain relief, and a clear plan.</h3>
            <p className="mt-5 leading-8 text-slate-300">
              Emergency appointments focus on diagnosing the cause quickly and getting you comfortable. Depending on the problem, this may include x-rays, drainage of infection, temporary stabilisation, repair of a broken tooth, re-cementing a crown, or planning the next stage of care.
            </p>
            <p className="mt-5 leading-8 text-slate-400">
              If you have major swelling, trauma, bleeding, or systemic symptoms, do not delay. Early treatment usually means less pain, less damage, and fewer complications.
            </p>
          </div>

          <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-white/5 p-3 shadow-xl shadow-black/20 backdrop-blur-sm">
            <img src={branding.CT3} alt="Urgent dental appointment" className="h-[320px] w-full rounded-[1.5rem] object-cover" />
          </div>
        </div>
      </section>
    );
